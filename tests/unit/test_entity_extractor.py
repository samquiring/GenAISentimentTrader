...
class TestEntityExtractor:
    ...
    def mock_dspy_settings(self):
        ...
        with patch(
            "genaisentimenttrader.processors.entity_extractor.dspy.settings"
        ) as mock_settings:
            yield mock_settings
    ...
    def mock_dspy_predict(self):
        ...
        with patch(
            "genaisentimenttrader.processors.entity_extractor.dspy.Predict"
        ) as mock_predict:
            yield mock_predict
    ...
    def mock_dspy_lm(self):
        """Mock dspy.LM class."""
        with patch(
            "genaisentimenttrader.processors.entity_extractor.dspy.LM"
        ) as mock_lm:
            yield mock_lm
    ...
    def test_init_custom_model(
        self, mock_dspy_settings, mock_dspy_predict, mock_dspy_lm
    ):
    ...
    @pytest.mark.asyncio
    async def test_forward_multiple_entities(
        self, entity_extractor, sample_content_item
    ):
    ...
    @pytest.mark.asyncio
    async def test_forward_symbol_normalization(
        self, entity_extractor, sample_content_item
    ):
    ...
    @pytest.mark.asyncio
    async def test_forward_context_stripping(
        self, entity_extractor, sample_content_item
    ):
